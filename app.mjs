...
app.get("/mistg/createTrainee", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "index.html"));
});

app.get("/mistg/jwks", async function (req, res) {
  let ks;
  try {
...
app.get("/mistg/updateTadabaseTrainee", async (req, res) => {
...
app.get("/mistg/callback", async function (req, res) {
  try {
